...
| :- | -: | :- |
| [concepts/](concepts/) | 21 | [skill-evidence-ledger](concepts/skill-evidence-ledger.md), [jd-read-centralisation](concepts/jd-read-centralisation.md), [source-lane-provenance](concepts/source-lane-provenance.md), [case-study-generation](concepts/case-study-generation.md), [incremental-case-study-refine](concepts/incremental-case-study-refine.md), [coach-stages](concepts/coach-stages.md), [filter-then-rank-retrieval](concepts/filter-then-rank-retrieval.md), [per-phase-evals](concepts/per-phase-evals.md) |
