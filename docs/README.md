...
| [decisions/](decisions/) | 10 | [ADR 0008 — OAuth token envelope encryption](decisions/0008-oauth-token-envelope-encryption.md), [ADR 0007 — assessment-only matcher](decisions/0007-assessment-only-matcher.md), [ADR 0001 — deterministic over LLM extraction](decisions/0001-deterministic-over-llm-extraction.md) |
