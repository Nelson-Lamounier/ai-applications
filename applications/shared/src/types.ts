...
export type AgentName =
    | 'research' | 'writer' | 'qa'
    | 'strategist-research' | 'strategist-writer' | 'strategist-coach' | 'strategist-summary' | 'strategist-summary-rewrite' | 'strategist-experience' | 'strategist-experience-rewrite'
    | 'jd-extractor'
    | 'role-classifier'
    | 'resume-builder'
    | 'project-clustering'
