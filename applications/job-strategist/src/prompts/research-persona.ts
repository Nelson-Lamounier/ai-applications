...
export const RESEARCH_PERSONA_SYSTEM_PROMPT: SystemContentBlock[] = [
    {
        text: [
            ...
            `- For every verifiedMatch or partialMatch backed by a KB passage, put that passage's EXACT`,
            `  source path (the part after "Source: ") in the "evidenceFiles" array of that match.`,
            ...
            `   - verifiedMatches: KB/project/career evidence CLEARLY demonstrates this skill (cite the source)`,
