...
export const STRATEGIST_PERSONA_SYSTEM_PROMPT: SystemContentBlock[] = [
    {
        text: [
            ...
            `   - The lead identity / profile.title MUST be a POSITIONING HEADLINE of the form`,
            `     "<target-aligned role> · <domain breadth>" (e.g. "Technical Support Engineer · Cloud & AI Operations")`,
            `, a descriptive positioning, NEVER a literal claim of holding the JD title,`,
            `     so it never conflicts with the candidate's real employment titles.`,
