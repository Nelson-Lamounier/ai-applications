...
export const STRATEGIST_PERSONA_SYSTEM_PROMPT: SystemContentBlock[] = [
    {
        text: [
            ...
            `        number or delivery metric from KB — PREFER a number NOT already used in`,
            `        an experience bullet, so the summary adds signal instead of repeating`,
            `        one. If no measured value exists in KB context, use the`,
