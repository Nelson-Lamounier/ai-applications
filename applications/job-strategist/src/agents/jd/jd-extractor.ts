...
const JD_EXTRACTOR_PROMPT = loadPrompt('jd-extractor-persona');
const SYSTEM_PROMPT = JD_EXTRACTOR_PROMPT.body;
...
export async function extractJdSignal(
    ...
    const config: AgentConfig = {
        ...
        promptId:       JD_EXTRACTOR_PROMPT.meta.id,
        promptVersion:  JD_EXTRACTOR_PROMPT.meta.version,
        tool: {
